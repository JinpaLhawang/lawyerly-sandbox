...
public class Provider2PactTests {

  @Rule
  public PactProviderRule mockProvider = new PactProviderRule("provider2", "localhost", 8080, this);

  @Pact(provider = "provider2", consumer = "consumer2")
  public PactFragment createFragment(PactDslWithProvider builder) {
    ...
    return builder.
        uponReceiving("a request for Thing").
        path("/thing/1234567890").
  ...
  public void runTest() throws IOException {
    ...
    body("multipleAppsUse", is(notNullValue()));
  }
